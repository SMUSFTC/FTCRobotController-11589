# FTC Team 11589 2017-2018 Season Robot Controller Archive
This repository contains the archived Robot Controller source code for team 11589, Fusion, created for and used during the 2017-2018 FIRST Tech Challenge season. The sources contained here are a fork of [the FIRST Tech Challenge Robot Controller base app at version 3.6](https://github.com/ftctechnh/ftc_app), and where modified to support the controlling scheme needed for the robot that was built. Major contributors to the fork include team member [Adrian Lee (@adrianlee12345)](https://github.com/adrianlee12345), and [Alex Fanat](https://github.com/TheFanatr).
